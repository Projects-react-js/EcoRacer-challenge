  ...
  return (
    <div className=" w-auto flex flex-col items-center gap-5">
        ...
        <div className="flex gap-5">
            <button onClick={start} className="bg-[#0000ff] text-white font-bold rounded-3xl border-[#0000ff] hover:bg-white hover:text-[#0000ff] border-2 px-4 py-2 sm:py-3 sm:px-5 md:py-4 md:px-6 shadow-[0_0_10px_#0000ff] hover:shadow-[0_0px_15px_#0000ff] transition duration-500 ease-in-out">
            Start</button>

            <button onClick={finish} className="bg-red-700 text-white font-bold rounded-3xl border-red-700 hover:bg-white hover:text-red-700 border-2 px-4 py-2 sm:py-3 sm:px-5 md:py-4 md:px-6 shadow-[0_0_10px_#b91c1c] hover:shadow-[0_0_15px_#b91c1c] transition duration-500 ease-in-out">Finish</button>
        </div>
    </div>
  );
}